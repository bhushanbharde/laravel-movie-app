...
} elseif ($_instance->childHasBeenRendered('peMK6KW')) {
    $componentId = $_instance->getRenderedChildComponentId('peMK6KW');
    $componentTag = $_instance->getRenderedChildComponentTagName('peMK6KW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('peMK6KW');
} else {
    $response = \Livewire\Livewire::mount('search-dropdown', []);
    $html = $response->html();
    $_instance->logRenderedChild('peMK6KW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /Users/vijayabharde/Desktop/Lara/movie-app/resources/views/layout/main.blade.php ENDPATH**/ ?>