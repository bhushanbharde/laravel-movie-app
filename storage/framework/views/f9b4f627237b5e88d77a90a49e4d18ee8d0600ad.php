<?php $__env->startSection('content'); ?>
    <div class="movie-info border-b border-gray-800 ">
        <div class="container mx-auto md:px-24 px-4 py-16 flex flex-col md:flex-row">
            <img src="<?php echo e($movie['poster_path']); ?>" alt="" class="w-full md:w-96">
            ...
            <div class="md:ml-24">
                ...
                <div class="mt-2">
                    <div class="flex flex-wrap items-center to-gray-400 text-sm mt-1">
                        ...
                        <span class="mx-2">|</span>
                        <span><?php echo e($movie['genres']); ?></span>
                    </div>
                                ...
                                <div class="bg-gray-900 rounded">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                            <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/<?php echo e($movie['videos']['results'][0]['key']); ?>" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <?php $__currentLoopData = $movie['cast']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($loop->index < 10): ?>
                        <div class="mt-8">
                            ...
                            <div class="mt-2">
                                <a href="" class="text-lg mt-3 hover:text-gray-300"><?php echo e($cast['name']); ?></a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vijayabharde/Desktop/Lara/movie-app/resources/views/show.blade.php ENDPATH**/ ?>